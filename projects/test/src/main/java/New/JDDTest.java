...
//    int z=bdd.createVar();
    ...
    int v5 = bdd2.createVar();
    int v6 = bdd2.createVar();
    int v7 = bdd2.createVar();
    int v8 = bdd2.createVar();


    int f=bdd.ref(bdd.and(v1, v2));
    int n=f;
//    n=bdd.ref(bdd.and(n,v3));
//    n=bdd.ref(bdd.or(n,v3));
    bdd.deref(f);
    int m=bdd.ref(bdd.and(f,v1));
//    f=bdd.and(f, 0);
//    f=bdd.or(f, v3);
//    bdd.ref(f);
    bdd.printSet(f);
