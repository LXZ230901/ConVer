...
public class BgpRoute extends AbstractRoute {//这一部分是需要更改的
  ...
  public static class Builder extends AbstractRouteBuilder<Builder, BgpRoute> {
    ...
    public Builder() {
      ...
      BDDFactory factory=BDDFactory.init(2,2);
      factory.setVarNum(1);
      _topologyCondition=factory.ithVar(0);
      _topologyCondition=_topologyCondition.biimpWith(factory.ithVar(0));
    }

    public Builder(BDDFactory factory) {
      _asPath = new ArrayList<>();
      _communities = new TreeSet<>();
      _clusterList = new TreeSet<>();
      _topologyCondition=factory.ithVar(0);
    ...
    public Builder setTopologyCondition(BDD topologyCondition) { //对应拓扑条件
  ...
  private static final String PROP_TOPOLOGYCONDITION = "topologyCondition";//对应拓扑条件
  ...
  public BgpRoute(
      ...
      @JsonProperty(PROP_TOPOLOGYCONDITION) BDD topologyCondition) {//对应拓扑条件
    super(network);
    _admin = admin;
    _asPath = asPath;
    _clusterList =
    ...
    _srcProtocol = srcProtocol;
    _weight = weight;
    _topologyCondition=topologyCondition;//对应拓扑条件
  }
  ...
  @JsonProperty(PROP_TOPOLOGYCONDITION)
  public BDD getTopologyCondition() { return _topologyCondition; }

  @JsonProperty(PROP_TOPOLOGYCONDITION)
  public void setTopologyCondition(BDD topologyCondition) { _topologyCondition=topologyCondition; }
}
