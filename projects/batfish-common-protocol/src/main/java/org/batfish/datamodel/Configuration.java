...
public final class Configuration extends ComparableStructure<String> {
  ...
  public static final String EDGE_ENCODE = "engeEncode";
  ...
  private NavigableMap<String, CommunityList> _communityLists;//community属性值
  ...
  private HashMap<String,Integer> _edgeEncode;

  public Map<String,Edge> _incomingEdges;

  public List<PrefixSpace> _networkPrefix;

  public List<ExplicitPrefixSet> _explicitPrefixSet;
  public Set<NamedPrefixSet> _namedPrefixSet;

  public List<InlineCommunitySet> _inlineCommunity;
  ...
  public Configuration(
    ...
    _vrfs = new TreeMap<>();
    _zones = new TreeMap<>();
    _edgeEncode =new HashMap<>();
    _incomingEdges=new HashMap<>();
    _networkPrefix=new ArrayList<>();

    _explicitPrefixSet=new ArrayList<>();
    _namedPrefixSet=new HashSet<>();
    _inlineCommunity = new ArrayList<>();
  }

  public void addInlineCommunity(InlineCommunitySet inlineCommunity)
  {
    _inlineCommunity.add(inlineCommunity);
  }

  public List<InlineCommunitySet> getInlineCommunity()
  {
    return this._inlineCommunity;
  }
  ...
  public void addNetworkPrefix(PrefixSpace prefix)
  {
    _networkPrefix.add(prefix);
  }

  public List<PrefixSpace> getNetworkPrefix()
  {
    return _networkPrefix;
  }

  public void addExplicitPrefixSet(ExplicitPrefixSet explicitPrefixSet)
  {
    _explicitPrefixSet.add(explicitPrefixSet);
  }

  public List<ExplicitPrefixSet> getExplicitPrefixSet()
  {
    return _explicitPrefixSet;
  }
}
