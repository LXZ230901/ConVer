...
public class BgpAdvertisement implements Comparable<BgpAdvertisement>, Serializable {
  ...
  public static class Builder {
    ...
    private BDD _topologyCondition;//对应的拓扑条件的编码
  ...
  private static final String PROP_TOPOLOGY_CONDITION="topologyCondition";//对应拓扑条件
  ...
  private final BDD _topologyCondition;//对应拓扑条件
  ...
  public BgpAdvertisement(
      ...
      @JsonProperty(PROP_TOPOLOGY_CONDITION)  BDD topologyCondifiton) {
    _type = type;
    _network = network;
    _nextHopIp = nextHopIp;
    _srcNode = srcNode;
    ...
    _weight = weight;
    _topologyCondition = topologyCondifiton;//对应拓扑条件
  }
  ...
  @JsonProperty(PROP_TOPOLOGY_CONDITION)//对应拓扑条件
  public BDD get_topologyCondition() { return _topologyCondition; }
