...
import static org.batfish.datamodel.IsisLevel.intersection;
import static org.batfish.datamodel.IsisLevel.union;
...
//        Arrays.equals(proc1.getNetAddress().getAreaId(), proc2.getNetAddress().getAreaId());
    boolean sameArea=proc1.getNetAddress().getAreaId().equals(proc2.getNetAddress().getAreaId());
...
//      return empty();
//    }
    if(proc1.getNetAddress().getSystemId()==proc2.getNetAddress().getSystemId())
    {
      return empty();
    }
