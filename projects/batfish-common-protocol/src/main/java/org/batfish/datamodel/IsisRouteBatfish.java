...
public class IsisRouteBatfish extends AbstractRoute{
  ...
  public static class Builder {
    ...
    @Nonnull
    public IsisRouteBatfish build() {
      return new IsisRouteBatfish(
          _admin,
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof IsisRouteBatfish)) {
      return false;
    }
    IsisRouteBatfish rhs = (IsisRouteBatfish) o;
