...
public class VirtualRouter extends ComparableStructure<String> {
  ...
  public void initBaseBgpRibs(
    ...
    if (_vrf.getBgpProcess() != null) {
      ...
      for (BgpAdvertisement advert : externalAdverts) {//引入外部路由宣告
    ...
    for (BgpNeighbor neighbor : _vrf.getBgpProcess().getNeighbors().values()) {
      ...
      for (AbstractRoute route : candidateRoutes) {
        ...
        if (routeIsBgp) {
          ...
          transformedOutgoingRouteBuilder.setTopologyCondition(bgpRoute.getTopologyCondition()); // 对应处理拓扑条件
      ...
      for (BgpNeighbor remoteBgpNeighbor : bgpTopology.adjacentNodes(neighbor)) {
        ...
        for (AbstractRoute remoteRoute : remoteCandidateRoutes) {
          ...
          if (remoteRouteIsBgp) {
            ...
            transformedOutgoingRouteBuilder.setTopologyCondition(bgpRemoteRoute.getTopologyCondition());//对应拓扑条件
          ...
          if (acceptOutgoing) {
            ...
            boolean sentReceivedFromRouteReflectorClient =
                transformedOutgoingRoute.getReceivedFromRouteReflectorClient();
            AsPath sentAsPath = transformedOutgoingRoute.getAsPath();
            BDD sentTopologyCondition = transformedOutgoingRoute.getTopologyCondition();// 对应拓扑条件
            SortedSet<Long> sentCommunities = transformedOutgoingRoute.getCommunities();
            ...
            if (acceptIncoming) {
              ...
              BDD receivedTopologyCondition = transformedIncomingRoute.getTopologyCondition();
