...
public class IsisProtocolHelper {
  ...
  public static RibDelta<IsisRoute> setOverloadOnAllRoutes(@Nonnull RibDelta<IsisRoute> delta) {
    ...
    RibDelta.Builder<IsisRoute> deltaWithOverloadTrue = new Builder<>(null);
    delta
        .getActions()
        .forEach(
            ra -> {
...
//  }
  ...
  public static IsisRoute.Builder convertNonIsisRouteToIsisRoute(
    ...
    return IsisRoute.builder()
        ...
        .setArea(process.getNetAddress().getAreaId().toString())
        .setTag(route.getTag())
        ...
        .setSystemId(Long.toString(process.getNetAddress().getSystemId()))
        .setNonRouting(true);
  }
}
