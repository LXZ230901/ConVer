...
public class WorkMgrService {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  public JSONArray configureAnalysis(//配置分析对应的接口
      @FormDataParam(CoordConsts.SVC_KEY_API_KEY) String apiKey,
      @FormDataParam(CoordConsts.SVC_KEY_VERSION) String clientVersion,
      @FormDataParam(CoordConsts.SVC_KEY_CONTAINER_NAME) String containerName,
  ...
  public JSONArray uploadTestrig(
    ...
    try {
      ...
      System.out.println("------------------back-uploadtestrig:-----------------");
      System.out.println("Uploaded testrig:"+testrigName+" for container:"+containerName +"using api-key:"+apiKey);
