...
public class TracerouteQuestionPlugin extends QuestionPlugin {
  ...
  public static class TracerouteAnswerer extends Answerer {
    ...
    public AnswerElement answer() {
      String q=_question.toString();
      String srcNode="core-0";
      String dstNode="edge-2";
      _batfish.nodeReachAbility(srcNode,dstNode);
      System.out.println("Question:"+_question.toFullJsonString());
      //System.out.println("QuestionSrc:"+_question.getSrc());
